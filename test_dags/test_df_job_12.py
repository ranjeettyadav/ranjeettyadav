...
# define the dag
dag = DAG('test_df_job_12', # give the dag a name
...
run_entl_stat_hist = DataFlowJavaOperator(
	...
	options={
        ...
        'outputTable':"dmgcp-ingestion-poc:airflow_test.test_df_job_12",
        'outputTableWriteMethod':"write_truncate",
        'errorTable':"dmgcp-ingestion-poc:airflow_test.test_df_job_12",

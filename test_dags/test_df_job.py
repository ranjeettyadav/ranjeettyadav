...
# define the dag
dag = DAG('test_df_job', # give the dag a name
...
run_entl_stat_hist = DataFlowJavaOperator(
	...
	options={
        ...
        'outputTable':"dmgcp-ingestion-poc:airflow_test.wrt_stress_4gb_n14",
        'outputTableWriteMethod':"write_truncate",
        'errorTable':"dmgcp-ingestion-poc:airflow_test.wrt_stress_4gb_n14_error",
